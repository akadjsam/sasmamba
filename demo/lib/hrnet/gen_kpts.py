...
from lib.hrnet.lib.utils2.utilitys import plot_keypoint, PreProcess, write, load_json
from lib.hrnet.lib.config import cfg, update_config
from lib.hrnet.lib.utils2.transforms import *
from lib.hrnet.lib.utils2.inference import get_final_preds
...
def gen_video_kpts(video, det_dim=416, num_peroson=1, gen_output=False):
    ...
    human_model = yolo_model(inp_dim=det_dim)  # human detector model
    pose_model = model_load(cfg)  # pose model
    people_sort = Sort(min_hits=0)  # sort tracker
